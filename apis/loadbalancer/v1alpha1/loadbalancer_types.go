...
// DOLoadBalancerParameters define the desired state of a DigitalOcean LoadBalancer.
// Most fields map directly to a LoadBalancer:
// https://developers.digitalocean.com/documentation/v2/#load-balancers
type DOLoadBalancerParameters struct {
	...
	// If not provided the default one will be used: "round_robin"
	// +kubebuilder:validation:Enum=round_robin;least_connections
	// +optional
	Algorithm *string `json:"algorithm"`
	// An object specifying forward rules settings for the Load Balancer. If omitted, default values will be provided.
	ForwardingRules []*DOForwardingRule `json:"forwardingRules,omitempty"`
...
// DOForwardingRule define the DigitalOcean loadbalancers forward rules configurations.
type DOForwardingRule struct {
	// The entry protocol to be used. ie. tcp.
	EntryProtocol string `json:"entryProtocol,omitempty"`
	// The entry port to be used.
	EntryPort int `json:"entryPort,omitempty"`
	// The target protocol to be used. ie. tcp.
	TargetProtocol string `json:"targetProtocol,omitempty"`
	// The target port to be used.
	TargetPort int `json:"targetPort,omitempty"`
	// The certificate id to use if using ssl
	// +optional
...
type DOLoadBalancerHealthCheck struct {
	// The protocol to be used to perform the health check.
	...
	// The port number to the healthcheck will connect.
...
// A DOLoadBalancerObservation reflects the observed state of a LB on DigitalOcean.
type DOLoadBalancerObservation struct {
...
// A DOLoadBalancerSpec defines the desired state of a LB.
type DOLoadBalancerSpec struct {
	xpv1.ResourceSpec `json:",inline"`
	ForProvider       DOLoadBalancerParameters `json:"forProvider"`
}

// A DOLoadBalancerStatus represents the observed state of a LB.
type DOLoadBalancerStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          DOLoadBalancerObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// A DOLoadBalancer is a managed resource that represents a DigitalOcean LB.
...
type DOLoadBalancer struct {
	...
	Spec   DOLoadBalancerSpec   `json:"spec"`
	Status DOLoadBalancerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DOLoadBalancerList contains a list of LBs.
type DOLoadBalancerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DOLoadBalancer `json:"items"`
}
