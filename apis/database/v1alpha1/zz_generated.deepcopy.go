...
func (in *DODatabaseCluserParameters) DeepCopyInto(out *DODatabaseCluserParameters) {
	*out = *in
	if in.Engine != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DODatabaseCluserParameters.
func (in *DODatabaseCluserParameters) DeepCopy() *DODatabaseCluserParameters {
	if in == nil {
		return nil
	}
	out := new(DODatabaseCluserParameters)
	in.DeepCopyInto(out)
	return out
}
